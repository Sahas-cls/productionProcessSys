    ...
    <div className="min-h-screen bg-gray-50 p-3 md:p-8">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <p className="text-gray-600 mt-1 md:mt-2 text-sm md:text-base">
          Create and manage production line layouts {styleId}
        </p>
      </div>
              ...
              return (
                <Form>
                  ...
                  <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 md:space-x-4 mt-6 md:mt-8 pt-4 md:pt-6 border-t border-gray-200">
                    <button
                      type="button"
                      className="border rounded-md py-2 px-2 text-gray-700 font-medium"
                      onClick={() => navigate(-1)}
                    >
                      Go Back
                    </button>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-1 text-sm md:text-base">
                  {workstations.length} workstation
                  {workstations.length !== 1 ? "s" : ""} •{" "}
                  {currentWorkstations.length} showing
                </p>
              </div>
          ...
          {workstations.length > itemsPerPage && (
            <div className="bg-gray-50 px-4 md:px-6 py-3 border-b">
              <ReactPaginate
                ...
                pageClassName={""}
                pageLinkClassName={
                  "px-2 md:px-3 py-1.5 md:py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-100 transition-colors duration-200 min-w-[32px] md:min-w-[40px] text-center text-sm"
                }
                previousClassName={""}
                previousLinkClassName={
                  "px-2 md:px-4 py-1.5 md:py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-100 transition-colors duration-200 text-sm"
                }
                nextClassName={""}
                nextLinkClassName={
                  "px-2 md:px-4 py-1.5 md:py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-100 transition-colors duration-200 text-sm"
                    ...
                    {currentWorkstations.map((workstation, wsIndex) => {
                      ...
                      return (
                        <div
                          ...
                          className="border border-gray-200 rounded-lg md:rounded-xl p-3 md:p-4 lg:p-6 hover:border-blue-300 transition-colors duration-200"
                        >
                          {/* Workstation Header */}
                          <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6 p-3 md:p-4 bg-gray-50 rounded-lg">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                              <div className="flex items-center">
                                <label className="text-xs md:text-sm font-medium text-gray-700 mr-2 whitespace-nowrap">
                                  WS No:
                                </label>
                                <Field
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                      {values.workstations[globalWsIndex]
                                        ...
                                        <tr>
                                          <td
                                            colSpan={5}
                                            className="px-4 md:px-6 py-4 md:py-8 text-center text-gray-500"
                                          >
                                            <div className="flex flex-col items-center">
                                              <svg
                                                className="w-10 h-10 md:w-12 md:h-12 text-gray-400 mb-2"
                                                fill="none"
                                                stroke="currentColor"
                                                viewBox="0 0 24 24"
                                              >
                                              ...
                                              <p className="text-xs text-gray-400">
                                                Add your first operation to get
                                                started
                                              </p>
                                            </div>
                                          </td>
                                  ...
                                  {values.workstations[globalWsIndex]
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-6 text-center">
                                      ...
                                      <p className="text-xs text-gray-400 mt-1">
                                        Add your first operation to get started
                                      </p>
                                    </div>
                                  ) : (
                                    values.workstations[
