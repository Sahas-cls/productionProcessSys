...
import { FaFileExcel, FaTrash, FaDownload, FaArrowLeft } from "react-icons/fa";
  ...
  const fetchTechPacks = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/subOperationMedia/getTechPacks/${subOpId}`,
      ...
      Swal.fire({
        title: "Error",
        text: "Failed to load tech packs",
        icon: "error",
  ...
  const handleDelete = async (id, fileName) => {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/subOperationMedia/deleteTechPack/${id}`,
        { withCredentials: true }
      );
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          title: "Deleted!",
          text: "Tech pack has been deleted.",
          icon: "success",
          timer: 2000,
      ...
      Swal.fire({
        title: "Error",
        text: "Failed to delete tech pack. Please try again.",
        icon: "error",
        confirmButtonText: "OK",
      });
    } finally {
    ...
    <div className="px-4 md:px-8 lg:px-16 xl:px-32 min-h-screen bg-gray-50 py-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="text-sm text-gray-600 bg-white px-3 py-1 rounded-full shadow-sm">
          Total Tech Packs: {techPacks.length}
        </div>
      </div>
      ...
      <div className="mb-8">
        <div className="w-full flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">Tech Packs</h1>
              ...
              return (
                ...
                >
                  <div className="relative w-full aspect-video bg-gray-100 group">
                    ...
                    >
                      <FaFileExcel className="text-2xl text-green-500" />
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-lg mb-2 line-clamp-1">
                      {item.sub_operation_name || "Untitled tech pack"}
                    </h3>
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        {userRole === "Admin" && (
                          <button
                            onClick={() => handleDelete(item.so_tech_id, fileName)}
