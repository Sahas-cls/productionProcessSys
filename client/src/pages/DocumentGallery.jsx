...
import { FaFolder, FaTrash, FaDownload, FaArrowLeft } from "react-icons/fa";
  ...
  const fetchDocuments = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/subOperationMedia/getFolderDocuments/${subOpId}`,
  ...
  const handleDelete = async (id, fileName) => {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/subOperationMedia/deleteFolderDocument/${id}`,
        { withCredentials: true }
      );
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-lg mb-2 line-clamp-1">
                      {item.sub_operation_name || "Untitled document"}
                    </h3>
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        {userRole === "Admin" && (
                          <button
                            onClick={() => handleDelete(item.so_folder_id, fileName)}
