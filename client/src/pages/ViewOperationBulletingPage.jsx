...
import AddOperationBulletingPage from "./AddOperationBulletingPage";
import ViewOperationBulletin from "../components/ViewOperationBulleting";

const ViewOperationBulletingPage = () => {
...
export default ViewOperationBulletingPage;
