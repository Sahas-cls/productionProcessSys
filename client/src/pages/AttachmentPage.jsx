...
const AttachmentPage = () => {
  ...
  const fetchAttachments = async () => {
    try {
      ...
      let url = `${backendUrl}/api/attachment/attachment-media`;
      ...
      if (response.data.success) {
        setAttachments(response.data.data.media || []);
      }
    } catch (error) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <input
                ...
                className="px-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-64"
              />
            </div>
